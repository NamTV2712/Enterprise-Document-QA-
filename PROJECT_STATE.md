...
- Text-section status after annual-report recovery: 41 filings expose all four target sections and 9 remain degraded but searchable; no configured ticker is unusable.
...
- Qdrant local currently indexes 9,703 chunks from all 50 configured tickers.
